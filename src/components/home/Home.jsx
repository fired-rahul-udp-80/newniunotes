                    ...
                    <div className="w-full md:w-[75%] flex flex-col gap-y-2 md:gap-y-6 xl:gap-y-8 px-5 py-5 md:py-8">
                        ...
                        <div className=" font-medium flex flex-col gap-y-2 md:gap-y-3">
                            ...
                            <div className="flex flex-col lg:flex-row gap-y-3 gap-x-3 md:gap-x-6 mt-5 text-xs h-fit">
                                ...
                                <a href={holidayList} target="_blank" className="px-4 md:px-6 py-3 md:py-5 w-[60%] xl:w-auto md:text-lg text-center bg-bgColor text-secondaryColor font-bold font-titleFont rounded-md cursor-pointer hover:opacity-80 ">Holiday List</a>
                                </div>
