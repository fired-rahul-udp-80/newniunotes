    ...
    <div>
        ...
        <div className=" h-full flex px-6 relative overflow-hidden items-center font-bodyFont ">
            <div className="w-full max-w-[1360px] h-full mx-auto flex items-center justify-center">
             ...
             <div className="w-full z-20 mb-12 mt-5 lg:mt-10 rounded-3xl flex flex-col-reverse md:flex-row gap-x-10  items-center bg-gradient-to-bl from-bgColor to-gray-900 md:px-4 py-4 md:py-10 text-white ">
                    <div className="w-full md:w-[75%] flex flex-col gap-y-2 sm:gap-y-6 xl:gap-y-8 px-5 py-5 md:py-8">
                        ...
                        <div className=" font-medium flex flex-col gap-y-2 md:gap-y-3">
                           ...
                           <div className="flex flex-col lg:flex-row gap-y-3 gap-x-3 md:gap-x-6 text-xs h-fit">
                                ...
                                <a href={syllabus} target="_blank" className="px-4  md:px-6 py-2 lg:py-5 w-[50%] xl:w-auto text-center md:text-lg bg-bgColor text-secondaryColor border-b-[7px] border-r-[7px] border-red-950 font-bold font-titleFont rounded-md cursor-pointer hover:opacity-80 ">Syllabus</a>
                                <a href={holidayList} target="_blank" className="px-4 md:px-6 py-2 lg:py-5 w-[60%] xl:w-auto md:text-lg text-center bg-bgColor text-secondaryColor border-b-[7px] border-r-[7px] border-red-950 font-bold font-titleFont rounded-md cursor-pointer hover:opacity-80 ">Holiday List</a>
                                </div>
                                
                                <a href={academic} target="_blank" className="px-4 md:px-6 py-2 lg:py-5 w-[70%] md:w-auto text-center md:text-lg bg-bgColor text-secondaryColor border-b-[7px] border-r-[7px] border-red-950 font-bold rounded-md font-titleFont cursor-pointer hover:opacity-80 ">Academic Calendar</a>
                            </div>
                        </div>
                    </div>
                    <div className='h-fit w-fit flex flex-col items-center gap-y-1 md:gap-y-3 px-5 md:px-6 py-6 md:py-10 border-[1px] border-red-800 rounded-3xl'>
                        <span className="text-3xl md:text-4xl xl:text-6xl">📚</span>
                        <div className="text-lg sm:text-xl xl:text-3xl nav-part2 font-semibold font-titleFont ">NIU Notes</div>
                    </div>
                </div>
            </div>
            <div className="z-30">
        ...
        <div>
            <div className="max-w-[1360px] mx-auto">
                <p className="ml-5 text-2xl text-center sm:text-left md:text-3xl lg:text-4xl text-bgColor font-titleFont font-[600]"> Top Reviews from Our Community...</p>
            </div>
